let products = [
    ...
    },
    {
        ...
        name: 'Proweb burger',
        price: 44000,
        img: 'https://i.ytimg.com/vi/Bzbl2fQ-XRQ/maxresdefault.jpg?sqp=-oaymwEmCIAKENAF8quKqQMa8AEB-AH-CYAC0AWKAgwIABABGGUgVShGMA8=&rs=AOn4CLABRhYo3TNdJg42GC5l-XE8ZihyDQ',
        amount: 0,
        get totalSum() {
            return this.price * this.amount
        }
...
function createBurger({name, img, price, amount}) {
   ...
   // ДЗ
   let wrappernav = document.querySelector('.wrapper__nav');
   ...
   function updateCount() {
       if (count < 100) {
           ...
           titleElement.style.transition = 'color 500ms, font-size 500ms';
           document.body.style.transition = 'background-color 500ms';
           wrappernav.style.transition = 'background-color 500ms';
           
           titleElement.textContent = count + ' lvl';
           document.body.style.backgroundColor = 'lightGrey';
           titleElement.style.color = 'green';
           titleElement.style.fontSize = '70px';
           wrappernav.style.backgroundColor = 'orange';
       }
   }
